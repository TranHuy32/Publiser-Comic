...
export default function Login() {
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            ...
            if (!formData.publisherName || !formData.password) {
                setIsEmpty(true);
                return;
            }
            if (!response.data) {
    ...
    return (
        <div className="login-wrapper">
            ...
            <form onSubmit={handleSubmit}>
                ...
                {isWrongCredentials && (
                    <p className="errWrongAuth">Sai tài khoản hoặc mật khẩu</p>
                )}
                {isEmpty && (
                    <p className="errEmpty">
                        Hãy điền đầy đủ thông tin đăng nhập!!!
                    </p>
                )}
                <div>
